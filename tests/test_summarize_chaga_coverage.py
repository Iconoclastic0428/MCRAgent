...
def test_summarize_coverage_rows_flags_sparse_train_play_slice():
    train_rows = [
        {"teacher_family": "PLAY", "turn": 7, "candidate_count": 30, "relaxed_region": "first_four_play"},
        {"teacher_family": "CHI", "turn": 18, "candidate_count": 3, "relaxed_region": "other"},
    ]
    val_rows = [
        {"teacher_family": "PLAY", "turn": 8, "candidate_count": 32, "relaxed_region": "first_four_play"},
        {"teacher_family": "PLAY", "turn": 9, "candidate_count": 34, "relaxed_region": "first_four_play"},
    ]
